...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //public static final String DATABASE_NAME = "/storage/emulated/0/Android/data/asd.sdsd/files/Pictures" + File.separator + "asas.db";
    ...
    // http://takeourorder.com/GiftX/ws.giftx.php?op=List_AppLabels&lid=1
    ...
    //http://takeourorder.com/GiftX/ws.giftx.php?op=List_Alerts&lid=2&user_type=1
